...
#     export QT6_POSITIONING_UIBCDF_SOURCE_PREFIX=/path/to/PySide6       # dir with Qt/
#     export QT6_POSITIONING_UIBCDF_SOURCE_REPO=/path/to/qtpositioning   # dir with src/
...
# Resolve the output artifact path (does not build).
